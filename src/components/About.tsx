        ...
        <div className="flex flex-col lg:flex-row items-start gap-12">
          ...
          >
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow">
              ...
              <div className="px-6 pt-0 pb-6 relative">
                ...
                <p className="text-slate-600 mb-4">Senior Documentation Engineer</p>
          ...
          >
            ...
            <p className="text-slate-700 mb-6 leading-relaxed">
              I've worked with engineering teams across startups and enterprises, from fintech platforms to banking systems, including a payments documentation specialism serving integration partners and clients. I've learned to navigate complex technical environments, adapt to different team cultures, and find the best ways to document everything from well-established APIs to rapidly evolving products. More recently I've been putting AI-assisted workflows to the test properly: last year they enabled a 164% increase in my documentation output, same hours, no overtime. Each project has taught me something new about making technical information accessible and useful.
            </p>
            <p className="text-slate-700 mb-6 leading-relaxed">
