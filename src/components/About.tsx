    ...
    <section id="about" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          I turn tech jargon into English. 20+ years wrestling with APIs, SDKs, and enterprise software has taught me that good documentation isn't about showing how clever you are - it's about helping someone get their job done without wanting to throw their laptop out the window.
          </p>
        </div>
