      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600">
            Over 20+ years, I've developed a diverse skill set spanning technical writing, information architecture, and cross-functional collaboration. Here's what I bring to documentation projects.
          </p>
        </motion.div>
